<?php
/**
 * Class RW_More_Rpi_Virtuell_Widget_Autoloader
 *
...
class RW_More_Rpi_Virtuell_Widget_Autoloader { 
     ...
     * @access  public
     * @static
     * @action  rw_more_rpi_virtuell_widget_autoload_register
     * @return  void
     */
    public static function register() {
        spl_autoload_register( 'RW_More_Rpi_Virtuell_Widget_Autoloader::load' ); 
        do_action( 'rw_more_rpi_virtuell_widget_autoload_register' ); //
    }
    ...
    public static function unregister() {
        spl_autoload_unregister( 'RW_More_Rpi_Virtuell_Widget_Autoloader::load' ); 
        do_action( 'rw_more_rpi_virtuell_widget_autoload_unregister' ); //
    }
